...
static inline double hb_q2d(hb_rational_t a) { return a.num / (double)a.den; }
...
typedef enum {
  ...
  HB_HDR_DYNAMIC_METADATA_ALL =
      HB_HDR_DYNAMIC_METADATA_HDR10PLUS | HB_HDR_DYNAMIC_METADATA_DOVI
...
struct hb_job_s {
  ...
  // Changing the constant values requires changes in
  // win/CS/HandBrake.Interop/Interop/HbLib/NativeConstants.cs for Windows GUI
...
#define HB_VCODEC_X264_8BIT                                                    \
  (0x00000002 | HB_VCODEC_X264_MASK | HB_VCODEC_H264_MASK)
#define HB_VCODEC_X264 HB_VCODEC_X264_8BIT
#define HB_VCODEC_X264_10BIT                                                   \
  (0x00000003 | HB_VCODEC_X264_MASK | HB_VCODEC_H264_MASK)

#define HB_VCODEC_X265_8BIT                                                    \
  (0x00000004 | HB_VCODEC_X265_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_X265 HB_VCODEC_X265_8BIT
#define HB_VCODEC_X265_10BIT                                                   \
  (0x00000005 | HB_VCODEC_X265_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_X265_12BIT                                                   \
  (0x00000006 | HB_VCODEC_X265_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_X265_16BIT                                                   \
  (0x00000007 | HB_VCODEC_X265_MASK | HB_VCODEC_H265_MASK)
...
#define HB_VCODEC_FFMPEG_VCE_H264                                              \
  (0x0000000D | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H264_MASK)
#define HB_VCODEC_FFMPEG_VCE_H265                                              \
  (0x0000000E | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_VCE_H265_10BIT                                        \
  (0x0000000F | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_VCE_AV1                                               \
  (0x00000010 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_AV1_MASK)

#define HB_VCODEC_FFMPEG_MF_H264                                               \
  (0x00000020 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H264_MASK)
#define HB_VCODEC_FFMPEG_MF_H265                                               \
  (0x00000021 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_MF_AV1                                                \
  (0x00000022 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_AV1_MASK)

#define HB_VCODEC_FFMPEG_NVENC_H264                                            \
  (0x00000030 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H264_MASK)
#define HB_VCODEC_FFMPEG_NVENC_H265                                            \
  (0x00000031 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_NVENC_H265_10BIT                                      \
  (0x00000032 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_NVENC_AV1                                             \
  (0x00000033 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_AV1_MASK)
#define HB_VCODEC_FFMPEG_NVENC_AV1_10BIT                                       \
  (0x00000034 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_AV1_MASK)

#define HB_VCODEC_FFMPEG_FFV1 (0x00000040 | HB_VCODEC_FFMPEG_MASK)

#define HB_VCODEC_SVT_AV1_8BIT                                                 \
  (0x00000041 | HB_VCODEC_SVT_AV1_MASK | HB_VCODEC_AV1_MASK)
#define HB_VCODEC_SVT_AV1 HB_VCODEC_SVT_AV1_8BIT
#define HB_VCODEC_SVT_AV1_10BIT                                                \
  (0x00000042 | HB_VCODEC_SVT_AV1_MASK | HB_VCODEC_AV1_MASK)
...
#define HB_VCODEC_VT_H265_10BIT                                                \
  (0x00000052 | HB_VCODEC_VT_MASK | HB_VCODEC_H265_MASK)

#define HB_VCODEC_FFMPEG_QSV_H264                                              \
  (0x00000060 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_QSV_MASK |                   \
   HB_VCODEC_H264_MASK)
#define HB_VCODEC_FFMPEG_QSV_H265_8BIT                                         \
  (0x00000061 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_QSV_MASK |                   \
   HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_QSV_H265_10BIT                                        \
  (0x00000062 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_QSV_MASK |                   \
   HB_VCODEC_H265_MASK)
#define HB_VCODEC_FFMPEG_QSV_H265 HB_VCODEC_FFMPEG_QSV_H265_8BIT

#define HB_VCODEC_FFMPEG_QSV_AV1_8BIT                                          \
  (0x00000070 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_QSV_MASK | HB_VCODEC_AV1_MASK)
#define HB_VCODEC_FFMPEG_QSV_AV1_10BIT                                         \
  (0x00000071 | HB_VCODEC_FFMPEG_MASK | HB_VCODEC_QSV_MASK | HB_VCODEC_AV1_MASK)
...
#define HB_MUX_AV_AVI 0x800000
#define HB_MUX_MASK_MKV 0x300000
#define HB_MUX_MASK_AV 0xE20000
...
#define HB_MUX_AVI HB_MUX_AV_AVI
...
/* Audio starts here */
/* Audio Codecs: Update
 * win/CS/HandBrake.Interop/Interop/HbLib/NativeConstants.cs when changing these
 * consts */
...
#define HB_ACODEC_PASS_MASK                                                    \
  (HB_ACODEC_AC3 | HB_ACODEC_DCA | HB_ACODEC_DCA_HD | HB_ACODEC_FFAAC |        \
   HB_ACODEC_FFEAC3 | HB_ACODEC_FFALAC | HB_ACODEC_FFFLAC | HB_ACODEC_MP2 |    \
   HB_ACODEC_MP3 | HB_ACODEC_FFTRUEHD | HB_ACODEC_VORBIS | HB_ACODEC_OPUS)
...
struct hb_audio_config_s {
  ...
  struct {
    ...
    PRIVATE int matrix_encoding;   /* Source matrix encoding mode, set by the
                                      audio decoder */
    PRIVATE hb_channel_layout_t
        *ch_layout; /* Source channel layout, set by the audio decoder */
...
#define HB_DECODE_HWACCEL                                                      \
  (HB_DECODE_NVDEC | HB_DECODE_VIDEOTOOLBOX | HB_DECODE_QSV | HB_DECODE_MF)
...
struct hb_motion_metric_object_s {
  ...
  float (*work)(hb_motion_metric_object_t *, hb_buffer_t *, hb_buffer_t *);
...
#ifdef __LIBHB__
  int (*init)(hb_blend_object_t *, int in_width, int in_height, int in_pix_fmt,
              int in_chroma_location, int in_color_range, int overlay_pix_fmt);
  hb_buffer_t *(*work)(hb_blend_object_t *, hb_buffer_t *, hb_buffer_list_t *,
                       int changed);
